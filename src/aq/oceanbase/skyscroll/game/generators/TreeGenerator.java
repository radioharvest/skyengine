package aq.oceanbase.skyscroll.game.generators;
...
public class TreeGenerator {
    ...
    public NodeConnection[] getConnections() {
        ...
        tempConnections.add(new NodeConnection(3, 7, 3));
        ...
        tempConnections.add(new NodeConnection(7, 11, 7));
        ...
        tempConnections.add(new NodeConnection(11, 15, 11));
        ...
        tempConnections.add(new NodeConnection(15, 19, 15));
        ...
        tempConnections.add(new NodeConnection(19, 23, 19));
        ...
        tempConnections.add(new NodeConnection(23, 27, 23));
        ...
        tempConnections.add(new NodeConnection(27, 31, 27));

        tempConnections.add(new NodeConnection(0, 6, 28));
        //tempConnections.add(new NodeConnection(2, 4, 29));

        tempConnections.add(new NodeConnection(5, 11, 30));
        //tempConnections.add(new NodeConnection(7, 9, 31));

        tempConnections.add(new NodeConnection(8, 14, 32));
        tempConnections.add(new NodeConnection(10, 12, 33));

        tempConnections.add(new NodeConnection(13, 19, 34));
        //tempConnections.add(new NodeConnection(15, 17, 35));

        tempConnections.add(new NodeConnection(16, 22, 36));
        tempConnections.add(new NodeConnection(18, 20, 37));

        //tempConnections.add(new NodeConnection(21, 27, 38));
        //tempConnections.add(new NodeConnection(23, 25, 39));

        tempConnections.add(new NodeConnection(24, 30, 40));
        tempConnections.add(new NodeConnection(26, 28, 41));
    ...
    public void genNodes() {
        ...
        nodeList.add(new Node(2, 5.0f, 2.0f, 0.0f).setOutboundConnections(new int[] {6, 4}).setState(Node.NODESTATE.OPEN));
        nodeList.add(new Node(3, 0.0f, 3.0f, 5.0f).setOutboundConnections(new int[] {7}).setState(Node.NODESTATE.OPEN));

        nodeList.add(new Node(4, 4.33f, 5.0f, 2.5f).setOutboundConnections(new int[] {8}));
        nodeList.add(new Node(5, -2.5f, 6.0f, 4.33f).setOutboundConnections(new int[] {9, 11}));
        ...
        nodeList.add(new Node(8, 2.5f, 10.0f, 4.33f).setOutboundConnections(new int[] {12, 14}));
        nodeList.add(new Node(9, -4.33f, 11.0f, 2.5f).setOutboundConnections(new int[] {13}));
        nodeList.add(new Node(10, -2.5f, 12.0f, -4.33f).setOutboundConnections(new int[] {14, 12}));
        ...
        nodeList.add(new Node(13, -5.0f, 16.0f, 0.0f).setOutboundConnections(new int[] {17, 19}));
        ...
        nodeList.add(new Node(16, -5.0f, 20.0f, 0.0f).setOutboundConnections(new int[] {20, 22}));
        nodeList.add(new Node(17, 0.0f, 21.0f, -5.0f).setOutboundConnections(new int[] {21}));
        nodeList.add(new Node(18, 5.0f, 22.0f, 0.0f).setOutboundConnections(new int[] {22, 20}));
        ...
        nodeList.add(new Node(24, 2.5f, 30.0f, 4.33f).setOutboundConnections(new int[] {28, 30}));
        nodeList.add(new Node(25, -4.33f, 31.0f, 2.5f).setOutboundConnections(new int[] {29}));
        nodeList.add(new Node(26, -2.5f, 32.0f, -4.33f).setOutboundConnections(new int[] {30, 28}));
