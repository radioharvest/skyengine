...
import aq.oceanbase.skyscroll.game.graphics.elements.ui.ScoreBar;
import aq.oceanbase.skyscroll.game.graphics.elements.window.QuestionWindow;
import aq.oceanbase.skyscroll.engine.graphics.RenderContainer;
import aq.oceanbase.skyscroll.engine.graphics.elements.Background;
...
import aq.oceanbase.skyscroll.game.questions.QuestionManager;
...
public class Game implements Touchable2D {
    ...
    public class QuestionListener implements QuestionEventListener {
        @Override
    ...
    private GameContext createQuestionContext(Question question) {
        ...
        questionWindow.addQuestionEventListener(new QuestionListener());
